...
namespace AgentController.Migrations.Migrations
{
    ...
    [Migration("20260716080000_RenameRepoHostConnectionPatColumnsToNamedSecret")]
    partial class RenameRepoHostConnectionPatColumnsToNamedSecret
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgentController.Infrastructure.Data.Entities.NamedSecretEntity", b =>
                {
                    b.Property<string>("Id")
                        .IsRequired()
                        .HasMaxLength(256)
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("IX_NamedSecrets_Name");

                    b.ToTable("NamedSecrets", (string)null);
                });
            ...
            modelBuilder.Entity("AgentController.Infrastructure.Data.Entities.RepositoryHostConnectionEntity", b =>
                {
                    ...
                    b.Property<string>("PersonalAccessTokenSecretName")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AgentController.Infrastructure.Data.Entities.SecretVersionEntity", b =>
                {
                    ...
                    b.Property<string>("NamedSecretId")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("NamedSecretId", "VersionNumber")
                        .IsUnique()
                        .HasDatabaseName("IX_SecretVersions_NamedSecretId_VersionNumber");

                    b.HasOne("AgentController.Infrastructure.Data.Entities.NamedSecretEntity", "NamedSecret")
                        .WithMany("Versions")
                        .HasForeignKey("NamedSecretId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_SecretVersions_NamedSecrets_NamedSecretId");
            ...
            modelBuilder.Entity("AgentController.Infrastructure.Data.Entities.WorkSourceEnvironmentEntity", b =>
                {
                    ...
                    b.Property<int?>("PersonalAccessTokenSecretVersion")
                        .HasColumnType("INTEGER");
